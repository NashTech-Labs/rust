...
use crate::item_service_impl::item_eventsourcing::item_event::models::PItemEvent;
use crate::item_service_impl::item_eventsourcing::item_command::models::PItemCommand;
use crate::item_service_impl::item_eventsourcing::item_state::pitem_state::PItemState;
...
impl Aggregate for PItem {
    ...
    fn apply_event(state: &Self::State, evt: Self::Event) -> Result<Self::State> {
        let item_state: PItemState = match evt {
            ...
            PItemEvent::ItemRetrieved => PItemState {
                item: None,
                generation: state.generation + 1
            }
        };
    ...
    fn handle_command(_state: &Self::State, cmd: Self::Command) -> Result<Vec<Self::Event>> {
        let item_event: PItemEvent = match cmd {
            ...
            PItemCommand::UpdatePrice { price } => PItemEvent::PriceUpdated { item_id: 0, price },
        };
        Ok(vec![item_event])
    }
}